...
public class ConcurrentReadWriteObserver extends ComponentDefinition {
	private static final Logger log = LoggerFactory.getLogger(ConcurrentReadWriteObserver.class);
    ...
    public ConcurrentReadWriteObserver() {
    ...
    Handler<CheckTimeout> handleCheck = new Handler<CheckTimeout>() {
        ...
        public void handle(CheckTimeout event) {
            ...
            if(executions.size() == ConcurrentReadWriteScenario.EXECUTION_PROCESS_COUNT) {

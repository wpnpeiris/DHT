...
public class LineariazableReadWriteScenario {

	private static final int NUM_NODES = 10;
	
	public static final int EXECUTION_PROCESS_COUNT = 12;
		...
		public StartNodeEvent generate() {
			return new StartNodeEvent() {
				...
				public Class getComponentDefinition() {
					return LineariazableReadWriteObserver.class;
				}
		...
		SimulationScenario scenario = new SimulationScenario() {
			{
				...
				startReadClients3.startAfterTerminationOf(0, startReadClients2);
				startWriteClients2.startAfterTerminationOf(1000, startReadClients3);
				startReadClients22.startAfterTerminationOf(2000, startWriteClients2);
				startReadClients32.startAfterTerminationOf(0, startReadClients22);
				terminateAfterTerminationOf(100000, startWriteClients2);
			}
		};
		return scenario;
	}

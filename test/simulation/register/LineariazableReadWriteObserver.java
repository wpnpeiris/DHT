...
public class LineariazableReadWriteObserver extends ComponentDefinition {
	private static final Logger log = LoggerFactory.getLogger(LineariazableReadWriteObserver.class);
    ...
    public LineariazableReadWriteObserver() {
    ...
    Handler<CheckTimeout> handleCheck = new Handler<CheckTimeout>() {
        ...
        public void handle(CheckTimeout event) {
            ...
            if(executions.size() == LineariazableReadWriteScenario.EXECUTION_PROCESS_COUNT) {

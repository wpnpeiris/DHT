...
public class FailureWriterReadObserver extends ComponentDefinition {
	private static final Logger log = LoggerFactory.getLogger(FailureWriterReadObserver.class);
    ...
    public FailureWriterReadObserver() {
    ...
    Handler<CheckTimeout> handleCheck = new Handler<CheckTimeout>() {
        ...
        public void handle(CheckTimeout event) {
            ...
            if(executions.size() == FailureWriterReadScenario.EXECUTION_PROCESS_COUNT) {

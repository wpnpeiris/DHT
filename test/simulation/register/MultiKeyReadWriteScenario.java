...
public class MultiKeyReadWriteScenario {

	private static final int NUM_NODES = 10;
	
	public static final int EXECUTION_PROCESS_COUNT = 8;
	
	public static final int DATA_KEY1 = 100;
	public static final int DATA_KEY2 = 200;
		...
		public StartNodeEvent generate() {
			return new StartNodeEvent() {
				...
				public Class getComponentDefinition() {
					return MultiKeyReadWriteObserver.class;
				}
	...
	static Operation1 startWriteClient = new Operation1<StartNodeEvent, Integer>() {
		...
		public StartNodeEvent generate(final Integer writerId) {
			return new StartNodeEvent() {
				...
				@Override
				public Init getComponentInit() {
					return new WriteClient.Init(selfAdr, dest, (writerId == 1 ? DATA_KEY1 : DATA_KEY2),  (writerId == 1 ? DATA_VALUE1 : DATA_VALUE2));
				}
	...
	static Operation1 startReadClient = new Operation1<StartNodeEvent, Integer>() {
		...
		public StartNodeEvent generate(final Integer readerId) {
			return new StartNodeEvent() {
				...
				@Override
				public Init getComponentInit() {
					return new ReadClient.Init(selfAdr, dest, readerId == 1 ? DATA_KEY1 : DATA_KEY2);
				}
		...
		SimulationScenario scenario = new SimulationScenario() {
			{
				...
				StochasticProcess startReadClients1 = new StochasticProcess() {
					{
						eventInterArrivalTime(constant(1000));
						raise(1, startReadClient, new BasicIntSequentialDistribution(1));
					}
				};
				...
				startReadClients1.startAfterTerminationOf(1000, startReadClients2);

				terminateAfterTerminationOf(100000, startReadClients1);
			}
		};
		return scenario;
	}

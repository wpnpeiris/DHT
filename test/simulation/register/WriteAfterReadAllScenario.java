...
public class WriteAfterReadAllScenario {
		...
		public SetupEvent generate() {
			return new SetupEvent() {
				...
				public void setupGlobalView(GlobalView gv) {
					gv.setValue("simulation.register.type", "WRITE_READ");
					gv.setValue("simulation.register.read_same_value", true);
		...
		public StartNodeEvent generate() {
			return new StartNodeEvent() {
				...
				public Class getComponentDefinition() {
					return WriteAfterReadAllObserver.class;
				}
		...
		SimulationScenario scenario = new SimulationScenario() {
			{
				...
				startReadClients.startAfterTerminationOf(1000, startWriteClient1);				
